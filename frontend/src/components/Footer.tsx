// Composant Footer pour OpenProvena
...
const FOOTER_LINKS = {
  ...
  resources: [
    ...
    { key: 'nav.documentation', href: '/docs', label: 'Documentation' },
    { key: 'nav.github', href: 'https://github.com/openprovena/openprovena', label: 'GitHub' },
  ],
  legal: [
    { key: 'footer.legal', href: '/legal', label: 'Mentions légales' },
    { key: 'footer.privacy', href: '/privacy', label: 'Confidentialité' },
    { key: 'footer.terms', href: '/terms', label: 'Conditions' },
  ],
};
...
const SOCIAL_LINKS = [
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/openprovena',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/openprovena',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-white">OpenProvena</span>
            </Link>
