...
export const HOME_FEATURES = [
  {
    id: 'trust-analysis',
    title: 'Analyse de confiance',
    description: 'Obtenez un score de confiance détaillé basé sur plus de 50 signaux.',
    icon: (
  ...
  {
    id: 'source-tracking',
    title: 'Suivi des sources',
    description: 'Explorez les relations entre domaines, auteurs et organisations.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: 'Suivi des narratifs',
    description: 'Détectez et analysez la propagation des narratifs en ligne.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'ai-detection',
    title: 'Détection IA',
    description: 'Identifiez le contenu généré par intelligence artificielle.',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
